                                ...
                                <div class="container">
                                    ...
                                    <div class="container-fluid mt-3">
                                        <div class="row border-bottom pb-4">
                                            <div class="col">
                                                <p class="ms-5 mb-1"><b class="pe-2">Title: </b>' . $postRowSale["sale_title"] . '</p>
                                                <p class="ms-5 mb-1"><b class="pe-2">Author: </b>' . $postRowSale["sale_author"] . '</p>
                                                <p class="ms-5 mb-1"><b class="pe-2">Edition: </b>' . $postRowSale["sale_edition"] . '</p>
                                                <p class="ms-5 mb-1"><b class="pe-2">Language: </b>' . $postRowSale["sale_language"] . '</p>
                                                <p class="ms-5 mb-1"><b class="pe-2">Genre: </b>' . $postRowSale["sale_genre"] . '</p>
                                                <p class="ms-5 mb-1"><b class="pe-2">Condition: </b>' . $postRowSale["sale_condition"] . '</p>
                                            </div>
                                            <div class="col me-5">
                                                <div class="card" style="width: 18rem;">
                                                    <img src="data:image/jpeg;base64,' . base64_encode($postRowSale["sale_book_photo"]) . '" class="card-img-top" alt="...">
                                                    <div class="card-body container-fluid pb-1 pt-1" style="border: 1px solid #8A6342; color: #8A6342; background-color: #EEEBEB;">
                                                        <div class="row p-0">
                                                            ...
                                                            <p class="col card-text fw-bold mb-0 px-1 text-end">' . $postRowSale["sale_price"] . '</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    while ($postRowExchange = $result_query_exchange->fetch_assoc()) {
                                        ...
                                        <div class="container-fluid mt-3">
                                            <div class="row border-bottom pb-4">
                                                <div class="col">
                                                    <p class="ms-5 mb-1"><b class="pe-2">Title: </b>' . $postRowExchange["exchange_title"] . '</p>
                                                    <p class="ms-5 mb-1"><b class="pe-2">Author: </b>' . $postRowExchange["exchange_author"] . '</p>
                                                    <p class="ms-5 mb-1"><b class="pe-2">Edition: </b>' . $postRowExchange["exchange_edition"] . '</p>
                                                    <p class="ms-5 mb-1"><b class="pe-2">Language: </b>' . $postRowExchange["exchange_language"] . '</p>
                                                    <p class="ms-5 mb-1"><b class="pe-2">Genre: </b>' . $postRowExchange["exchange_genre"] . '</p>
                                                    <p class="ms-5 mb-1"><b class="pe-2">Condition: </b>' . $postRowExchange["exchange_condition"] . '</p>
                                                    <p class="ms-5 mb-1" style="text-align: justify;"><b>Exchange Preferences: </b>
                                                        <br> &emsp;' . $postRowExchange["exchange_preferences"] . '
                                                    </p>
                                                </div>
                                                <div class="col me-5">
                                                    <div class="card" style="width: 18rem;">
                                                        <img src="data:image/jpeg;base64,' . base64_encode($postRowExchange["exchange_book_photo"]) . '" class="card-img-top" alt="...">
                                                        <div class="card-body container-fluid pb-1 pt-1" style="border: 1px solid #8A6342; color: #8A6342; background-color: #EEEBEB;">
                                    ...
                                    while ($postRowRent = $result_query_rent->fetch_assoc()) {
                                        ...
                                        <div class="container-fluid mt-3">
                                            <div class="row border-bottom pb-4">
                                                <div class="col">
                                                    <p class="ms-5 mb-1"><b class="pe-2">Title: </b>' . $postRowRent["rent_title"] . '</p>
                                                    <p class="ms-5 mb-1"><b class="pe-2">Author: </b>' . $postRowRent["rent_author"] . '</p>
                                                    <p class="ms-5 mb-1"><b class="pe-2">Edition: </b>' . $postRowRent["rent_edition"] . '</p>
                                                    <p class="ms-5 mb-1"><b class="pe-2">Language: </b>' . $postRowRent["rent_language"] . '</p>
                                                    <p class="ms-5 mb-1"><b class="pe-2">Genre: </b>' . $postRowRent["rent_genre"] . '</p>
                                                    <p class="ms-5 mb-1"><b class="pe-2">Condition: </b>' . $postRowRent["rent_condition"] . '</p>
                                                    <p class="ms-5 mb-1"><b class="pe-2">Rental Duration: </b>' . $postRowRent["rental_duration"] . '</p>
                                                    <p class="ms-5 mb-1"><b class="pe-2">Security Deposit: </b>' . $postRowRent["security_deposit"] . '</p>
                                                    <p class="ms-5 mb-1" style="text-align: justify;"><b>Rental Terms & Conditions: </b>
                                                        <br> &emsp;' . $postRowRent["rental_terms_and_conditions"] . '
                                                    </p>
                                                </div>
                                                <div class="col me-5">
                                                    <div class="card" style="width: 18rem;">
                                                        <img src="data:image/jpeg;base64,' . base64_encode($postRowRent["rent_book_photo"]) . '" class="card-img-top" alt="...">
                                                        <div class="card-body container-fluid pb-1 pt-1" style="border: 1px solid #8A6342; color: #8A6342; background-color: #EEEBEB;">
                                                            <div class="row p-0">
                                                                <p class="col card-text fw-bold mb-0 px-1">FOR RENT</p>
                                                                <p class="col card-text fw-bold mb-0 px-1 text-end">' . $postRowRent["rental_price"] . '</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

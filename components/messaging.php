        ...
        <div class="container py-5">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-5 col-xl-5 mb-4 mb-md-0">
                    ...
                    <h5 class="fw-bold mb-3 text-center text-white">Member</h5>
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="p-2 border-bottom" style="border-bottom: 1px solid rgba(255,255,255,.3) !important;">
                                    <a href="#!" class="d-flex justify-content-between link-light">
                                        ...
                                        <img src="../assets/accounts.png" alt="avatar" class="rounded-circle d-flex align-self-center me-3 shadow-1-strong" width="60">
                                            <div class="pt-1">
                ...
                <div class="col-md-6 col-lg-7 col-xl-7">
                    ...
                    <ul class="list-unstyled text-white">
                        <li class="d-flex justify-content-between mb-4">
                            <img src="../assets/accounts.png" alt="avatar" class="rounded-circle d-flex align-self-start me-3 shadow-1-strong" width="60">
                            <div class="card mask-custom">
                        ...
                        <li class="mb-3">
                            <div class="form-outline form-white">
                                <textarea class="form-control" id="textAreaExample3" rows="4" placeholder="Message"></textarea>
                                <!-- <label class="form-outline" for="textAreaExample3">Message</label> -->
                            </div>
                        </li>
